...
class Map:
    ...
    def add_markers(self):
        ...
        marker1 = folium.Marker([51.766564986894885, 19.456798138876003],
                                popup="<h1>Mis Uszatek</h1><img src='photos/pobrane.jpg' width = 400px/><p> <Teddy Bear Uszatek in Lodz is a small sculpture of this famous fairy tale character, reaching about a meter, standing on the main promenade - Piotrkowska Street.></p>",
                                tooltip="Mis Uszatek", icon=folium.Icon(icon='heart', icon_color='pink'))
        marker2 = folium.Marker([51.77721719686519, 19.45463642538355], popup="<h1>Freedom Square</h1>",
                                tooltip="Laweczka Tuwima", icon=folium.Icon(icon='heart', icon_color='pink'))

        marker3 = folium.Marker([51.76792979001689, 19.456680333446094],
        ...
        marker4 = folium.Marker([51.77287876573184, 19.455790267712022],
